...
#include <memory>
#include "../../login/registerwindow.h"
...
QT_MOC_LITERAL(1, 15, 19), // "registrationSuccess"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 23), // "onRegisterButtonClicked"
QT_MOC_LITERAL(4, 60, 21) // "onCancelButtonClicked"

    },
    "RegisterWindow\0registrationSuccess\0\0"
    "onRegisterButtonClicked\0onCancelButtonClicked"
};
...
void RegisterWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onRegisterButtonClicked(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RegisterWindow::registrationSuccess)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterWindow::registrationSuccess()
{
