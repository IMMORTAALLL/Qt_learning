...
QT_MOC_LITERAL(4, 34, 17), // "onListItemClicked"
QT_MOC_LITERAL(5, 52, 11) // "QModelIndex"

    },
    "SidebarWidget\0itemSelected\0\0index\0"
    "onListItemClicked\0QModelIndex"
};
...
void SidebarWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onListItemClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SidebarWidget::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SidebarWidget::itemSelected)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SidebarWidget::itemSelected(int _t1)
{
